...
{
   /*
   Socket is created and bind attatches the given port number.
   Uses listen to mark that its' ready to accept connections.
...
{
   /*
   Blocks and waits until the client connects. Returns a new file descriptor for the file.
